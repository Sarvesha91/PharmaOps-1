...
export class InitSchema1763639603 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vendor_profiles" DROP CONSTRAINT "FK_658558b7f3a6163382505c8009"`);
